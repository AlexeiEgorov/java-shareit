...
public class PersistenceConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUsername(environment.getRequiredProperty("spring.datasource.username1"));
        dataSource.setPassword(environment.getRequiredProperty("spring.datasource.password1"));
        return dataSource;
    }
